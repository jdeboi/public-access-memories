    ...
    return (
        <div className="Statement  Page">
            <div className="container">
                ...
                <br />
                <iframe width="560" height="315" src="https://www.youtube.com/embed/o-Zw43PhvR8" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                <hr />
                <h3>Statement</h3>
                <p>
                ...
                <hr />
                <h3>Artists</h3>
                <p>Mitchell Craft, Samantha Blumenfeld, Lee Tusman, Kat Zhang, Dan Rule, Daria Ivans, Jenna deBoisblanc, Sidney Astl, Stefani Byrid, Lydia Mattson, Nathan Caldecott, Loraine Wilble, Freya Björg Olafson, Linda Loh</p>
