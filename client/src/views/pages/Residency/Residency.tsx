    ...
    <div className="Statement Page">
      <div className="container">
        ...
        <p>
          ...
          supporting peer critique, and fostering opportunities for
          collaboration. Artists meet regularly for one-on-one studio visits and
          group conversations, while also carving out time for independent
          research and digital experimentation.
        </p>

        <p>
          During the residency, artists also host online "office hours" where
          visitors can drop in to chat, watch work in progress, or simply
          observe the digital studio at work.
        </p>
