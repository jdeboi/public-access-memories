...
import { openCallVersions } from "../OpenCall/OpenCallBlackBox/versions";
...
export default function DeboxStatement() {
          ...
          >
            ...
            <div className="pointer-events-auto p-6 windowsBlack  mb-8 bg-black">
              ...
              <div className="flex flex-row items-center gap-4">
                <img
                  src="/iframes/opencall/assets/logo_white_sm.png"
                  className="block h-20 w-auto shrink-0"
                  alt="Logo"
                />
                <img
                  src="/iframes/opencall/assets/wrong_white.png"
                  className="block h-20 w-auto shrink-0"
                  alt="Wrong"
                />
              </div>
