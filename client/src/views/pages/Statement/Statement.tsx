          ...
          <React.Fragment>
            ...
            <div className="twoCol">
              <div>
                <p>
                  As part of{" "}
                  <a href="https://thewrong.org/">The Wrong Biennale</a>{" "}
                  2023-24, public access memories presents Fields of View, a
                  virtual “pavilion” of 12 digital artists exploring new modes
                  of representing, constructing, and traversing online space.
                </p>

                <p>
                  The primary channel for communication in many aspects of our
                  contemporary reality is the flatscreen computer monitor;
                  however, our perceptions of this technology are often altered
                  by illusions of space that betray the conditions of its
                  surface. At the two-dimensional level, scrolling and
                  hyperlinking operate as methods of expanding the spatial
                  boundaries of the screen into a dense, multidimensional
                  experience.
                </p>
                <p>
                  Three-dimensional projections push this expansion further, but
                  rarely deviate from conventional systems of linear
                  perspective. Within such conventions exist assumptions about
                  the relationship between ourselves and the environments we
                  inhabit that limit our potential scope of experience.
                </p>
                <p>
                  ...
                  perspective projections, isometric diagrams, glitch
                  landscapes, stereoscopic imagery, or simply the textual
                  description of spatial experience, the work in this exhibition
                  expands the space of the computer screen without attempting to
                  erase our awareness of it.
                </p>
              </div>
              <div>
