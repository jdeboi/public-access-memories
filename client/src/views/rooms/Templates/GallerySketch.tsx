...
//////////////
// HELPERS
import { doorCrossing, roomDoorCrossing, roomDoorEntryCrossing, roomDoorBoundary, roomBoundary, wallBoundary } from '../../Gallery/Gallery1/p5/functions/crossing';
import { roundToMult2 } from '../../Gallery/Gallery1/p5/functions/round';
import { drawAllFloors } from '../../Gallery/Gallery1/p5/functions/floor';
import { drawWalls, drawRooms } from '../../Gallery/Gallery1/p5/functions/building';
import { displayDancers, updateDucks } from '../../Gallery/Gallery1/p5/functions/emojis';
import { reachedDestination, getNextStep, showMouseLoc, showUserEllipses, showDestination, mouseDidMove } from '../../Gallery/Gallery1/p5/functions/destination';
import { drawUser, drawUsers, checkUserClicked } from '../../Gallery/Gallery1/p5/functions/users';
import { drawPlantRow, drawGrassPatch } from '../../Gallery/Gallery1/p5/functions/garden';
import { addTableDivs, displayTableDivs, addSwingDivs, displaySwingDivs, displayOakDivs, displayTreeDivs, displayBarDivs, displayTrashDivs, checkTrashDivsDouble, addTrashDivs, displayRoomLabelDivs, addDoorDivs, addLightDivs, addColumnDivs, addTreeDivs, addBarDivs, addOakDivs, addFolderDivs, displayDoorDivs, displayLightDivs, displayColumnDivs, endDivDrag, updateDivs, checkDivPress, displayFolderDivs, checkFolderDivsDouble, addRoomLabelDivs } from '../../Gallery/Gallery1/p5/functions/divs';
import TreeSlider from '../../Gallery/Gallery1/p5/components/TreeSlider';

//////////////
// COMPONENTS
import Wall from "../../Gallery/Gallery1/p5/components/Wall";
import Room from "../../Gallery/Gallery1/p5/components/Room";
import Duck from '../../Gallery/Gallery1/p5/components/Duck';
import Dancer from '../../Gallery/Gallery1/p5/components/Dancer';
...
import { displayWall } from "../../Gallery/Gallery1/p5/functions/ground";
