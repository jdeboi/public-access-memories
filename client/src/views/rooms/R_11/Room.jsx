...
const Room = () => {
    ...
    const InstaEmbed = (url) => {
        return (
            <blockquote className="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/tv/CZKTouSFbri/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style={{ background: "#FFF", border: 0, borderRadius: 3, boxShadow: "0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)", margin: 1, maxWidth: 540, minWidth: 326, padding: 0, width: "99.375%", width: "calc(100% - 2px)" }}>
                <div style={{ padding: 16 }}>
                    <a href="https://www.instagram.com/tv/CZKTouSFbri/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background: "#FFFFFF", lineHeight: 0, padding: "0 0", textAlign: "center", textDecoration: "none", width: "100%" }} target="_blank">
                        ...
                        <div style={{ display: "flex", flexDirection: "row", marginBottom: 14, alignItems: "center" }}><div>
                    ...
                    <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: 14, lineHeight: 17, marginBottom: 0, marginTop: 8, overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        <a href={`https://www.instagram.com/tv/${url}/?utm_source=ig_embed&amp;utm_campaign=loading`} style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: 14, fontStyle: "normal", fontWeight: "normal", lineHeight: 17, textDecoration: "none" }} target="_blank">A post shared by Loraine Wible (@lorainewibleart)</a>
                    </p>
                </div>
            </blockquote>
        )
...
//     curl -X GET \
//   "https://graph.facebook.com/v13.0/instagram_oembed?url=https://www.instagram.com/p/fA9uwTtkSN/&access_token=520353832844304|IGQVJWQzcwTlBkbHFDSXpHLXZAMRGwtajd4ZA1Q3SEYxelRTVjdOQkJGdEx4VlpXVHNTUTVrQXJwVFNwWXF4VC0zeU1wMkFjTW93ci1tUzg3MDVhdXdYbmlOQnhGNUw3ajR1M1ZA5bEUxeVNhb3pYbGxRbAZDZD"

    // "https://graph.facebook.com/v13.0/instagram_oembed?url=https://www.instagram.com/p/fA9uwTtkSN/&access_token="

    // https://graph.facebook.com/v11.0/instagram_oembed/?url=https%3A%2F%2Finstagr.am%2Fp%2FZw9o4%2F&hidecaption=false&omitscript=true&fields=html&maxwidth=320
    const appID= "340125738017219";
    const userID= "IGQVJWQzcwTlBkbHFDSXpHLXZAMRGwtajd4ZA1Q3SEYxelRTVjdOQkJGdEx4VlpXVHNTUTVrQXJwVFNwWXF4VC0zeU1wMkFjTW93ci1tUzg3MDVhdXdYbmlOQnhGNUw3ajR1M1ZA5bEUxeVNhb3pYbGxRbAZDZD"
    return (
        <div className="Room RoomLoraine Sketch">
            {/* <iframe src="https://www.instagram.com/p/CZKTouSFbri/" width={400} height={400} /> */}
            {/* <InstaEmbed url={"https://www.instagram.com/p/CZKTouSFbri/"} /> */}
            <InstagramEmbed
                url='https://instagr.am/p/Zw9o4/'
                clientAccessToken={`${appID}|${userID}`}
                maxWidth={320}
                hideCaption={false}
