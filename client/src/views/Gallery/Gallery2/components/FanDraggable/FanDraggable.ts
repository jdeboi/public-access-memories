...
export default class FanDraggable extends ShadowDraggable {
  ...
  constructor(
    ...
    this.fan = p5.loadImage(
      "https://netscapes.s3.us-east-2.amazonaws.com/infrastructure/fan.png"
    );
    this.blades = p5.loadImage(
      "https://netscapes.s3.us-east-2.amazonaws.com/infrastructure/blades.png"
    );
  }
