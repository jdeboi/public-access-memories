...
export default class ShadowDraggable extends Draggable {
    ...
    shadow: p5Types.Image;

    constructor(id: number, x: number, y: number, w: number, h: number, p5: p5Types, content: p5Types.Image | null) {
        super(id, x, y, w, h, p5, content);
        this.shadow = p5.loadImage("https://lmd-bucket.s3.us-east-2.amazonaws.com/sketches/gallery/tracklights/black_shadow.png");
    }
