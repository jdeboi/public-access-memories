...
//////////////
// CONFIG
import { GlobalConfig } from "../../../data/Shows/DaveGreber/GlobalConfig";
import { rooms as globalRooms } from "../../../data/Shows/DaveGreber/RoomConfig";
import {
  filterGalleryUsers,
  getTotalRoomCount,
...
import {
  barTenders,
  danceFloor,
} from "../../../data/Shows/DaveGreber/BotConfig";
...
var txtFile: p5Types.Image;
var instaImg: p5Types.Image;
...
class GallerySketchOG extends React.Component<Props> {
  ...
  userTakeStep = (p5: p5Types, x: number, y: number) => {
    ...
    if (userStep.x > p5.windowWidth / 2) {
      stepTo.x = -space - p5.windowWidth / 2;
    }
    // if (
    //   userStep.x > p5.windowWidth / 2 + space ||
    //   userStep.y > p5.windowHeight / 2 ||
    //   userStep.x < -p5.windowWidth / 2 - space ||
    //   userStep.y < -p5.windowHeight / 2
    // ) {
    //   this.stopWalking();
