...
export default class Swing extends Draggable {
    ...
    constructor(id, x, y, w, h, p5, baby, chain, GlobalConfig) {
        super(id, x, y, w, h, p5, baby, GlobalConfig);
    ...
    checkButton(userX, userY, GlobalConfig) {
    ...
    displayButton(userX, userY, GlobalConfig) {
        let mouse = mouseToWorld({ x: userX, y: userY }, this.p5, GlobalConfig);
        mouse.x -= this.x;
        mouse.y -= this.y;
