...
export const mouseToWorld = (userEase: { x: number, y: number }, p5: p5Types, GlobalConfig: any) => {
...
export const userToWorldCoords = (userX: number, userY: number, GlobalConfig: any) => {
