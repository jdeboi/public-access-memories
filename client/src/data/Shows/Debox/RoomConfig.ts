...
export const artists: IArtist[] = [
  ...
  },
  {
    ...
    medium: "3D rendering",
    description:
      "“perfect_day_at_the_beach.jpg” is a disorganized cross-section of different memories framed as a single perfect moment. The piece explores how our sense of memory degrades regardless of the existence of digital evidence and artifacts of the truth: images can always be changed. On social media, users self-curate idealized forms of themselves and their life which includes having to manufacture and perpetuate certain narratives; a process that mirrors our own biased and faulty self-actualization. There is no perfect day at the beach, and our perfect versions of memories can only exist within a distorted framing of the truth and without dimension.",
    year: 2022,
  ...
  },
  {
    ...
    description:
      'A self/portrait of my life during the pandemic, Sleeping Through The Pandemic was created in a game engine as a top-down 2dimensional narrative alternating between apartments and narrative text intertitles. The story is rendered in 8bit graphics, with pixelated graphics of bedrooms, desks, refridgerators, stoves, toilets, showers...the "stuff" around me. Spendingso much time in my bedroom during the pandemic, like being trapped, mymind turned to both reflection and the immediate environment. Playing mylife abstracts the experience, rendering it as a game, though of courseit\'s real to me',
    year: 2021,
  ...
  },
  {
    ...
    description:
      "Room /me is a tiny interactive visual essay about self-isolation and self-care during quarantine using p5.js",
    year: 2021,
  ...
  },
  {
    ...
    description:
      "Upwards shows the constant upward mobility expectations of a middle-class, middle-century American house.",
    year: 2022,
  ...
  },
  {
    ...
    description:
      "This work imagines my ancestors' home — the Northern Ural’s sacred places.",
    thumb: "ivans-thumb",
    year: 2021,
  },
  {
  ...
  },
  {
    ...
    description:
      "Mattson's work explores digital routines and media consumption through maximalist collage, combining diverse imagery and complicating visual relationships. Mattson’s mixed-media approach utilizes both print and video techniques, often in direct conversation with each other, and raises questions about online identities and the overlap between our physical and digital realities.",
    year: 2022,
  ...
  },
  {
    ...
    year: 2021,
    medium:
      "Altered bitmap image rendered from the 2b2t.org anarchy Minecraft server.",
    thumb: "nathan-thumb",
  },
  {
    id: 11,
