...
export const artists: IArtist[] = [
   
    {
        ...
        medium: "HTML",
        description: "Soft Corruptor is an unfolding html poem about pokemon blue, out of bounds areas, atomic structures, view source, and ghosts. Constructed out the html <details> tag, it is about surfaces and interiors in both subject and form.",
        year: 2021,
    ...
    },
    {
        ...
        medium: "HTML",
        description: "'Transparens' is a part of a larger body of work; each composition deals in some way with the tension between apparent flatness and felt dimension that screens produce. The work plays with the feedbacking of surface and depth, creating faux-dimensional 'stacks' of web elements.",
        year: 2023,
